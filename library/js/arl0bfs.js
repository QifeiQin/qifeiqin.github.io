...
window.Typekit.config = {
	"c": [".tk-minion-pro", "\"minion-pro\",serif", ".tk-brandon-grotesque", "\"brandon-grotesque\",sans-serif"],
	"f": "//use.typekit.net/c/45efdd/brandon-grotesque:n3:n7,minion-pro:n4.Y2j:N:2,Y2q:N:2,XvJ:N:2/{format}{/extras*}?",
	"fn": ["brandon-grotesque", ["n3", "n7"], "minion-pro", ["n4"]],
	"k": "//use.typekit.net/{
	}.js",
	"p": "//p.typekit.net/p.gif?s=1&k=arl0bfs&ht=tk&h={host}&f=6817.10296.10300&a=822193&_={_}",
	"w": "arl0bfs"
};
...
(function(window, document, undefined) {
	...
	u.prototype.Ja = m("Wa");
	u.prototype.hasWebFontSupport = u.prototype.Ja;
	u.prototype.Ka = m("ga");
	u.prototype.hasWebKitFallbackBug = u.prototype.Ka;
	u.prototype.La = m("Va");
	u.prototype.hasWebKitMetricsBug = u.prototype.La;
	...
	function z(a, b, c, d, e, f, g, h, p, M, E) {
		this.W = a;
		this.q = b;
		this.Ua = c;
		this.B = d;
	...
	ba("internalWebfont.UserAgent", z);
	z.prototype.getName = m("W");
	z.prototype.getName = z.prototype.getName;
	z.prototype.Ia = m("Ua");
	z.prototype.getVersion = z.prototype.Ia;
	z.prototype.Ea = m("B");
	z.prototype.getEngine = z.prototype.Ea;
	z.prototype.Fa = m("za");
	z.prototype.getEngineVersion = z.prototype.Fa;
	z.prototype.Ga = m("m");
	z.prototype.getPlatform = z.prototype.Ga;
	z.prototype.Ha = m("Qa");
	z.prototype.getPlatformVersion = z.prototype.Ha;
	z.prototype.Da = m("S");
	z.prototype.getDocumentMode = z.prototype.Da;
	z.prototype.Ca = m("A");
	z.prototype.getBrowserInfo = z.prototype.Ca;
	...
	ka.prototype.parse = function() {
		...
		if (-1 != this.e.indexOf("MSIE") || -1 != this.e.indexOf("Trident/")) {
			...
			var b = B(this),
				...
				f = k,
				g = k,
				h = C(this.e, /Trident\/([\d\w\.]+)/, 1),
				p = F(this.R),
				d = -1 != this.e.indexOf("MSIE") ? C(this.e, /MSIE ([\d\w\.]+)/, 1) : C(this.e, /rv:([\d\w\.]+)/, 1),
				e = y(d);
			"" != h ? (f = "Trident", g = y(h)) : (f = "Unknown", g = new v, h = "Unknown");
			a = new z("MSIE", e, d, f, g, h, a, c, b, p, new u("Windows" == a && 6 <= e.g || "Windows Phone" == a && 8 <= c.g, l, l))
		} else if (-1 != this.e.indexOf("Opera")) a: if (a = "Unknown", b =
				C(this.e, /Presto\/([\d\w\.]+)/, 1), c = y(b), d = B(this), e = y(d), f = F(this.R), c.g !== k ? a = "Presto" : (-1 != this.e.indexOf("Gecko") && (a = "Gecko"), b = C(this.e, /rv:([^\)]+)/, 1), c = y(b)), -1 != this.e.indexOf("Opera Mini/")) g = C(this.e, /Opera Mini\/([\d\.]+)/, 1), h = y(g), a = new z("OperaMini", h, g, a, c, b, A(this), e, d, f, new u(l, l, l));
			else {
				if (-1 != this.e.indexOf("Version/") && (g = C(this.e, /Version\/([\d\.]+)/, 1), h = y(g), h.g !== k)) {
					a = new z("Opera", h, g, a, c, b, A(this), e, d, f, new u(10 <= h.g, l, l));
					break a
				}
				g = C(this.e, /Opera[\/ ]([\d\.]+)/, 1);
				h = y(g);
				a = h.g !== k ? new z("Opera", h, g, a, c, b, A(this), e, d, f, new u(10 <= h.g, l, l)) : new z("Opera", new v, "Unknown", a, c, b, A(this), e, d, f, new u(l, l, l))
			...
			1 == h.g && 9 < h.o || 1 == h.g && 9 == h.o && 2 <= h.J || g.match(/1\.9\.1b[123]/) != k || g.match(/1\.9\.1\.[\d\.]+/) != k), a = new z(a, b, c, "Gecko", h, g, A(this), e, d, F(this.R), new u(f, l, l))) : a = la;
		return a
	};

	function A(a) {
		var b = C(a.e, /(iPod|iPad|iPhone|Android|Windows Phone|BB\d{2}|BlackBerry)/, 1);
		if ("" != b) return /BB\d{2}/.test(b) && (b = "BlackBerry"), b;
		a = C(a.e, /(Linux|Mac_PowerPC|Macintosh|Windows|CrOS)/, 1);
		return "" != a ? ("Mac_PowerPC" == a && (a = "Macintosh"), a) : "Unknown"
	}

	function B(a) {
		var b = C(a.e, /(OS X|Windows NT|Android) ([^;)]+)/, 2);
		if (b || (b = C(a.e, /Windows Phone( OS)? ([^;)]+)/, 2)) || (b = C(a.e, /(iPhone )?OS ([\d_]+)/, 2))) return b;
		if (b = C(a.e, /(?:Linux|CrOS) ([^;)]+)/, 1))
			for (var b = b.split(/\s/), c = 0; c < b.length; c += 1)
				if (/^[\d\._]+$/.test(b[c])) return b[c];
		return (a = C(a.e, /(BB\d{2}|BlackBerry).*?Version\/([^\s]*)/, 2)) ? a : "Unknown"
	}
	...
	function oa(a) {
		...
		"BuiltinBrowser" == g ? p = "Unknown" : "Silk" == g ? p = C(a.e,
			/Silk\/([\d\._]+)/, 1) : "Chrome" == g ? p = C(a.e, /(Chrome|CrMo|CriOS)\/([\d\.]+)/, 2) : -1 != a.e.indexOf("Version/") ? p = C(a.e, /Version\/([\d\.\w]+)/, 1) : "AdobeAIR" == g ? p = C(a.e, /AdobeAIR\/([\d\.]+)/, 1) : "Opera" == g ? p = C(a.e, /OPR\/([\d.]+)/, 1) : "PhantomJS" == g && (p = C(a.e, /PhantomJS\/([\d.]+)/, 1));
		h = y(p);
		M = "AdobeAIR" == g ? 2 < h.g || 2 == h.g && 5 <= h.o : "BlackBerry" == b ? 10 <= d.g : "Android" == b ? 2 < d.g || 2 == d.g && 1 < d.o : 526 <= f.g || 525 <= f.g && 13 <= f.o;
		return new z(g, h, p, "AppleWebKit", f, e, b, d, c, F(a.R), new u(M, 536 > f.g || 536 == f.g && 11 > f.o, "iPhone" ==
	...
	function ra(a) {
		...
		ha(a.n, a.r.h(a.s, "active")) || r(a.n, a.r.h(a.s, "inactive"));
		G(a, "inactive")
	}

	function G(a, b, c) {
		if (a.$[b])
			if (c) a.$[b](c.getName(), H(c));
			else a.$[b]()
	}
	...
	function ua(a, b, c, d, e, f, g, h) {
		...
		ta(a);
		for (var p in L) L.hasOwnProperty(p) && (sa(a, new J(L[p], H(this.C))), this.P[L[p]] = a.D.offsetWidth);
		a.remove()
	}
	var L = {
		bb: "serif",
	...
	ua.prototype.start = function() {
		...
		ta(this.N);
		this.Sa = ea();
		sa(this.M, new J(this.C.getName() + ",serif", H(this.C)));
		sa(this.N, new J(this.C.getName() + ",sans-serif", H(this.C)));
		va(this)
	};
	...
	N.prototype.Ba = function(a) {
		var b = this.G;
		s(b.n, b.r.h(b.s, a.getName(), H(a).toString(), "loading"));
		ha(b.n, b.r.h(b.s, a.getName(), H(a).toString(), "active")) || r(b.n, b.r.h(b.s, a.getName(), H(a).toString(), "inactive"));
		G(b, "fontinactive", a);
		ya(this)
	};

	function ya(a) {
		0 == --a.ba && a.qa && (a.wa ? (a = a.G, s(a.n, a.r.h(a.s, "loading")), s(a.n, a.r.h(a.s, "inactive")), r(a.n, a.r.h(a.s, "active")), G(a, "active")) : ra(a.G))
	}
	...
	Ca.prototype.toString = function() {
		for (var a = [], b = 0; b < this.v.length; b++)
			for (var c = this.v[b], d = c.H(), c = c.H(this.t), e = 0; e < d.length; e++) {
				var f;
				a: {
	...
	P.prototype.h = function(a, b) {
		var c = b || {},
			d = this.Ta.replace(/\{\/?([^*}]*)(\*?)\}/g, function(a, b, d) {
	...
	function S(a) {
		return Q(a) && 0 === w(a.l, new v(5, 1)) || Q(a) && 0 === w(a.l, new v(5, 2)) || Q(a) && 0 === w(a.l, new v(6, 0)) || Q(a) && x(a.l, new v(6, 1))
	}
	...
	function Ia(a, b) {
		return Ha(a, b) && x(a.l, new v(4, 2)) && -1 === w(a.l, new v(5))
	}
	...
	function Ka(a, b) {
		return U(a, b) && x(a.l, new v(2, 2)) && -1 === w(a.l, new v(3, 1))
	}

	function La(a, b) {
		return U(a, b) && x(a.l, new v(3, 1)) && -1 === w(a.l, new v(4, 1))
	}
	...
	var Ua = {
		...
		Va = {
			...
			b: function(a) {
				return Ma(a) && T(a) || Oa(a) && T(a) || Pa(a) && T(a) || "AdobeAIR" === a.getName() && x(a.q, new v(2, 5)) && T(a)
			},
			d: function(a, b) {
			...
			f: function(a, b) {
				return Qa(a) && La(a, b) || b.K && "Silk" === a.getName() && x(a.q, new v(2)) && (La(a, b) || V(a))
			},
			i: function(a) {
				return "MSIE" ===
	...
	X.prototype.init = function() {
		if (0 < this.Q.length) {
			for (var a = [], b = 0; b < this.Q.length; b++) a.push(Aa(this.Q[b]));
			var b = this.j,
				a = a.join(""),
				c = this.j.createElement("style");
	...
	X.prototype.load = function(a, b, c) {
		if (this.t) {
			for (var d = Xa[this.t] || new Ra(Ta), e = 0; e < this.v.length; e++) {
				for (var f = this.v[e], g = this.t, h = d, p = [], M = f.L.split(",")[0].replace(/"|'/g, ""), E = f.H(), R = p, D = void 0, I = [], Sa = {}, ma = 0; ma < E.length; ma++) D = E[ma], 0 < D.length && !Sa[D] && (Sa[D] = j, I.push(D));
				E = I;
				h = h.va ? h.va(M, E, R) : E;
				f.oa[g] = h;
				f.na[g] = p
			...
			if (this.aa) {
				d = W[this.t](this.j, this.t, this.v);
				e = this.t;
				f = [];
			...
			if (a) {
				var na = this,
					ob = this.t;
				ga(this.j, function() {
					for (var c = 0; c < na.v.length; c++) na.v[c].fa(a, ob, b && c == na.v.length - 1)
				})
			}
		}
	};
	X.prototype.collectFontFamilies = function(a, b) {
		if (this.t)
			for (var c = 0; c < this.v.length; c++) Ea(this.v[c], this.t, a, b)
	};
	...
	function Za(a, b) {
		if (0 != a.u.length) {
			a.la = b.contextPath || k;
			for (var c = new qa(a.j, a.n, b), d = l, e = 0; e < a.u.length; e++) a.u[e].init(), d = d || a.u[e].supportsConfiguredBrowser();
			if (d) {
				r(c.n, c.r.h(c.s, "loading"));
				G(c, "loading");
				for (var f = new N(a.e, a.j, c, b.timeout), c = function(a, b, c) {
					for (var d = [], e = 0; e < a.length; e += 1) {
						var R = a[e];
						if (b[R])
							for (var D = b[R], I = 0; I < D.length; I += 1) d.push(new J(R, D[I]));
						else d.push(new J(R))
					}
					f.fa(d, {}, k, c)
				}, d = 0; d < a.u.length; d++) e = a.u[d], e.supportsConfiguredBrowser() && (e.load(c, d == a.u.length -
		...
		if (a)
			for (var b = 0; b < this.u.length; b++) {
				...
				d && d(function(a, b, d) {
					a = [];
					b = {};
					var h = (new ka(navigator.userAgent, document)).parse(),
						p = c;
					p.e = h;
					p.t = Wa(p.e, p.Z);
	...
	ab.prototype.h = function(a, b) {
		...
		c.setAttribute("src", this.Ma.h(t(b)));
		...
		if ("MSIE" == a.getName() && "Windows Phone" != f) {
			...
			var g = this,
				h = function() {
					var a = cb(g, "scrollLeft", "scrollTop"),
						b = cb(g, "clientWidth", "clientHeight");
					c.style.bottom = "auto";
					c.style.right = "auto";
	...
	if (!window.Typekit.load) {
		var eb = window.Typekit.config || {},
			fb = k;
		eb.k && (fb = new P(eb.k));
		var gb = new Ya(fb, new fa(window), db, document.documentElement),
			hb = new $a(window);
		window.Typekit.load = function() {
			gb.load.apply(gb, arguments)
		};
		window.Typekit.addKit = function() {
			gb.Y.apply(gb, arguments)
		}
	}
	var ib, jb = k,
		kb = k,
		lb = k,
		mb, Y, Z, O = window.Typekit.config || {};
	O.b && (jb = new P(O.b), kb = new ab(window, document, jb, O.bu));
	O.p && (lb = new P(O.p));
	mb = new function() {
		var a = lb;
		this.ja = kb;
	...
	Z.Z = Y;
	O.w && (Z.xa = O.w);
	O.f && (ib = new P(O.f), Z.aa = ib);
	var i;
	if (O.fn)
		for (i = 0; i < O.fn.length; i += 2) Z.v.push(new Da(O.fn[i], O.fn[i + 1]));
	if (O.c)
		for (i = 0; i < O.c.length; i += 2) Z.Q.push(new za);
	var nb;
	if (nb = hb) nb = !!hb.I.__webfonttypekitmodule__;
	nb ? (hb.Y(Z), hb.load()) : (Z.e = db, Z.t = Wa(Z.e, Z.Z), window.Typekit.addKit(Z));
})(this, document);